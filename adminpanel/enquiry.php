<?php 
		...
		if(isset($_POST['create'])){
			...
			{  $insert=array('name'=>$name,'email'=>$email,'phone'=>$phone,'requirements'=>$requirements,'date'=>date('Y-m-d'),'status'=>1);
		...
		{
			extract($_POST);if(!empty($name) && !empty($email) && !empty($phone) && !empty($requirements))
			{$updatearray=array("id"=>$id);$upd2=array('name'=>$name,'email'=>$email,'phone'=>$phone,'requirements'=>$requirements,'date'=>date('Y-m-d'),'status'=>1);
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    <head><?php  
    echo $plugin->softwareTitle("Enquiry");
    ...
    <body class="">
        ...
        <div id="content">
        	<h1 class="content-heading bg-white border-bottom">Enquiry</h1>
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li class="active"><a href="#">Create New Enquiry</a></li>
                    <li><a href="enquiry_data.php">Enquiry List</a></li>
                </ul>
            </div>
                ...
                <!-- Widget -->
                        ...
                        <div class="widget widget-inverse" >
                            ...
                            <div class="widget-head">
                                <h4 class="heading">Update/Change - Enquiry</h4>
                            </div>
                            <!-- // Widget heading END -->
                            ...
                            <div class='col-sm-9'>
                                    <textarea id='form-field-1' name='requirements' placeholder='Requirements' class='summernote'><?php echo $obj->SelectAllByVal($table,"id",$_GET['edit'],"requirements"); ?></textarea>
                            </div>
                    </div><div class="form-group">
                            ...
                            <!-- Widget heading -->
                            <div class="widget-head">
                                <h4 class="heading">Create New Enquiry</h4>
                            </div>
                            <!-- // Widget heading END -->
                            ...
                            <div class='col-sm-9'>
                                    <textarea id='form-field-1' name='requirements' placeholder='Requirements' class='summernote'></textarea>
                            </div>
                    </div><div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
