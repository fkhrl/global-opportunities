            ...
            <script type="text/javascript">
                jQuery(document).ready(function () {
                    ...
                    var dataSource = new kendo.data.DataSource({
                        ...
                        schema: {
                            ...
                            model: {
                                id: "id",
                                fields: {
                                    id: {nullable: true},site_name: {type: "string"},photo: {type: "string"},address: {type: "string"},phone_number: {type: "string"},email: {type: "string"},facebook_link: {type: "string"},twitter_link: {type: "string"},google_plus_link: {type: "string"},youtube_link: {type: "string"},
									date: {type: "string"}
                                }
                            }
                        }
                    ...
                    jQuery("#site_basic_info_1").kendoGrid({
                        ...
                        sortable: true,
                        groupable: true,
                        columns: [{field: "id", title: "#"},{field: "site_name", title: "Site Name"},{field: "photo", title: "Photo"},{field: "address", title: "Address"},{field: "phone_number", title: "Phone Number"},{field: "email", title: "Email"},{field: "facebook_link", title: "Facebook Link"},{field: "twitter_link", title: "Twitter Link"},{field: "google_plus_link", title: "Google Plus Link"},{field: "youtube_link", title: "Youtube Link"},
