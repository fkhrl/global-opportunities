    ...
    <body class="">
        ...
        <div id="content">
          ...
          <div class="innerAll spacing-x2">
                <div class="col-sm-12" id="welcome_content_5"></div>
            </div>
        </div>
        <!-- // Welcome Content END -->
                ...
                function deleteClick(welcome_content_id) {
                    ...
                    if (c === true) {
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "./controller/welcome_content_controller.php",
                    ...
                    var dataSource = new kendo.data.DataSource({
                        ...
                        schema: {
                            ...
                            model: {
                                id: "id",
                                fields: {
                                    id: {nullable: true},title: {type: "string"},sub_title: {type: "string"},short_details: {type: "string"},
									date: {type: "string"}
                                }
                            }
                        }
                    });
                    jQuery("#welcome_content_5").kendoGrid({
                        ...
                        sortable: true,
                        groupable: true,
                        columns: [{field: "id", title: "#"},{field: "title", title: "Title"},{field: "sub_title", title: "Sub Title"},{field: "short_details", title: "Short Details"},
